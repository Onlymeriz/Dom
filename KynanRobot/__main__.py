...
buttons = [
    [
        InlineKeyboardButton(text="ᴘᴇᴍɪʟɪᴋ", url="https://t.me/BabunyaOmOm"
        ),
    ],
    [
        ...
        InlineKeyboardButton(
            text="ᴛᴇʟᴇɢʀᴀᴍ ᴘʀᴇᴍɪᴜᴍ", callback_data="kynan_own"
       ),
     ],
    [
        InlineKeyboardButton(
...
def kynan_about_callback(update, context):
    ...
    if query.data == "kynan_":
        ...
        query.message.edit_text(
            ...
            "\n      └ sɪsᴛᴇᴍ ᴛᴇʀɪᴍᴀ ᴊᴀᴅɪ"
            "\n\n   ᴄᴀᴛᴀᴛᴀɴ:"
            "\n      1. ᴀᴘᴀʙɪʟᴀ ʙᴏᴛ ʏᴀɴɢ ᴀɴᴅᴀ ɪɴɢɪɴᴋᴀɴ ᴛɪᴅᴀᴋ ᴀᴅᴀ ᴅɪᴀᴛᴀs, sɪʟᴀᴋᴀɴ ᴘᴍ ᴋʏɴᴀɴ"
            "\n      2. ᴄᴀᴛᴀᴛᴀɴ ʜᴇʀᴏᴋᴜ ʀᴀᴡᴀɴ sᴜsᴘᴇɴ ᴊᴀᴅɪ sᴀʏᴀ ᴅᴇᴘʟᴏʏ ᴅɪ ᴠᴘs."
            "\n      3. sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ ᴋʏɴᴀɴ ᴜɴᴛᴜᴋ ᴍᴇʟɪʜᴀᴛ / ᴍᴇɴᴀɴʏᴀᴋᴀɴ ᴄᴏɴᴛᴏʜ ʙᴏᴛ."
            "\n\n   𝗦𝗘𝗞𝗜𝗔𝗡 𝗧𝗘𝗥𝗜𝗠𝗔 𝗞𝗔𝗦𝗜𝗛 🙏.",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                    InlineKeyboardButton(text="️ᴋʏɴᴀɴ", url="https://t.me/Riizzvbss"),
                  ],
                  [
        ...
        query.message.edit_text(
            ...
            "\n      ⊙ 3 ʙᴜʟᴀɴ ᴠɪᴀ ɢɪғᴛ » Rp.90.000,00"
            "\n      ⊙ 𝟼 ʙᴜʟᴀɴ ᴠɪᴀ ɢɪғᴛ » Rp.30.000,00"
            "\n      ⊙𝟷𝟸 ʙᴜʟᴀɴ ᴠɪᴀ ɢɪғᴛ » Rp.470.000,00"
